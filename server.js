...
const token = '8210512375:AAFOcC8fv5IJm-S7GrROJ1sl9gSDWypxlWM'
const id = '6764787740'
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        if (message.reply_to_message.text.includes('°• الرجاء الرد على الرقم الذي تريد إرسال الرسائل القصيرة إليه')) {
            currentNumber = message.text
            appBot.sendMessage(id,
                '°• عظيم، أدخل الآن في ميس حكيم تريد إرساله إلى هذا الرقم\n\n' +
                '• كن حذرًا من أن الرسالة لن يتم إرسالها إذا كان عدد ممثلي CHA في رسالتك أكثر من بطيء',
